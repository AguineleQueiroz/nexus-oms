...
const consumers: Consumer[] = [
  { worker_id: 'w-1', worker_type: 'PaymentWorker',  queue_name: 'orders.payment', status: 'active',  last_heartbeat: new Date().toISOString(), events_processed: 50, events_failed: 2, started_at: '2024-01-01T09:00:00Z' },
  { worker_id: 'w-2', worker_type: 'AuditWorker',    queue_name: 'orders.audit',   status: 'idle',    last_heartbeat: new Date().toISOString(), events_processed: 30, events_failed: 0, started_at: '2024-01-01T09:00:00Z' },
  { worker_id: 'w-3', worker_type: 'NotifyWorker',   queue_name: 'orders.notify',  status: 'stopped', last_heartbeat: new Date().toISOString(), events_processed: 10, events_failed: 1, started_at: '2024-01-01T09:00:00Z' },
]
