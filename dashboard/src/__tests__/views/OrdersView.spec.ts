...
const makeResponse = (overrides: object = {}) => ({
  data: [
    { id: 'ord-1', customer_name: 'Ana', status: 'created', total: 100, customer_email: '', items: [], metadata: {}, created_at: '', updated_at: '' },
    { id: 'ord-2', customer_name: 'Bob', status: 'paid',    total: 200, customer_email: '', items: [], metadata: {}, created_at: '', updated_at: '' },
  ],
