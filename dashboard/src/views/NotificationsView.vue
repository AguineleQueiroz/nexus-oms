  ...
  <div class="notif-view">
    <div class="view-header">
      ...
      <div class="header-right">
        ...
        <button :class="{ spinning: loading }" class="refresh-btn" @click="load">
          <svg fill="none" height="14" viewBox="0 0 16 16" width="14">
            <path d="M13.5 8A5.5 5.5 0 1 1 8 2.5" stroke="currentColor" stroke-linecap="round" stroke-width="1.5"/>
            <path d="M8 2.5 10.5 5 8 7.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                  stroke-width="1.5"/>
          </svg>
        </button>
      </div>
    ...
    <div class="table-card">
      <table class="notif-table">
        ...
        >
          <td>
            <span :class="m.read ? 'read' : 'unread'" class="read-dot"/>
          </td>
          <td class="to-cell">{{ m.to }}</td>
          <td :class="{ bold: !m.read }" class="subject-cell">{{ m.subject }}</td>
        ...
        <tr v-if="loading && messages.length === 0">
          <td class="empty-row" colspan="6">Carregando...</td>
        </tr>
        </tbody>
      </table>
    </div>
