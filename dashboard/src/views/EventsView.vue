...
import type { OrderEvent, EventTypeCount } from '@/types'
...
<style scoped>
.events-view { display: flex; flex-direction: column; gap: 16px; }
...
.events-table td { padding: 8px 12px; border-bottom: 1px solid var(--color-border); }
.event-row:last-child td { border-bottom: none; }
.event-row:hover td { background: var(--color-surface-2, rgba(255,255,255,0.03)); }

.mono   { font-family: var(--font-mono); }
.dimmed { color: var(--color-text-muted); }
...
.type-badge.success { background: rgba(16,185,129,0.12); color: #10b981; }
.type-badge.danger  { background: rgba(239,68,68,0.12);  color: #ef4444; }
.type-badge.warning { background: rgba(245,158,11,0.12); color: #f59e0b; }
.type-badge.info    { background: rgba(59,130,246,0.12); color: #3b82f6; }
...
.payload-btn:hover { color: var(--color-amber); border-color: var(--color-amber); }
