...
const IconUsers  = () => h('svg', { viewBox: '0 0 14 14', fill: 'none', width: 14, height: 14 }, [
  ...
  h('path', { d: 'M1 12c0-2.21 1.79-4 4-4s4 1.79 4 4', stroke: 'currentColor', 'stroke-width': 1.5, 'stroke-linecap': 'round' }),
  h('path', { d: 'M10 2c1.1 0 2 .9 2 2s-.9 2-2 2M13 12c0-1.86-1.28-3.41-3-3.83', stroke: 'currentColor', 'stroke-width': 1.4, 'stroke-linecap': 'round' }),
])
...
.stat-card:hover { border-color: var(--card-accent); }
